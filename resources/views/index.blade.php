            ...
            <div class="row fullscreen justify-content-center align-items-center">
                <div class="col-md-10 col-12">
                    <div class="banner-content text-center mb-20">
                        ...
                        <h1 class="text-white mb-20 mt-80 text-uppercase">이현석의 라라벨 입문</h1>
                        <p class="text-white">이현석님의 유튜브 강의 "이현석의 라라벨 입문"</p>
                        <img class="hello-illustration" src="/assets/images/main/laravel-beginner-lee.png"
                             style="max-width:50%; height:auto;margin:auto;">
                        <a href="https://www.youtube.com/playlist?list=PLZU-Fw0hnhQb8B6hCQek2xXd5zNkyu_3U" target="_blank"
                           class="text-uppercase header-btn">보러가기</a>
                    </div>
                </div>
            </div>
        </div>
