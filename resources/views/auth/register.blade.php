                    ...
                    <div class="form-group">
                        <div class="col-md-12 ">
                            <div class="login" style="display:block">
                                ...
                                <a href="/plugin/social_login/login/github" target="_top">
                                    <i class="fonti um-github um-2x"></i>깃허브 계정으로 로그인</a>
                                <a href="/plugin/social_login/login/naver" target="_top" class="login_naver">
                                    <i class="fonti um-naver um-2x"></i>네이버 계정으로 로그인</a>
                                <a href="/plugin/social_login/login/facebook" target="_top" class="login_face">
